...
Class imyie_orderminprice extends CModule
{
	...
	{
		RegisterModuleDependences("sale", "OnSaleComponentOrderOneStepProcess", "imyie.orderminprice", "Imyie\\OrderMinPrice\\Main", "OnSaleComponentOrderOneStepProcess", 10000);
		return TRUE;
	}
